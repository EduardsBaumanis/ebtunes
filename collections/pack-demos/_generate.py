#!/usr/bin/env python3
"""Generate two strudel demo songs per sample repo from docs/STRUDEL_SAMPLE_REPOS.md.
...
Run: `python collections/pack-demos/_generate.py` from the repo root.
Idempotent — overwrites existing files in collections/pack-demos/.
"""
